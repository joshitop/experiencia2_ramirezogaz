...
const inputs = document.querySelectorAll('#formulario input'); //recordad que formualrios es un ID
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.usuario && campos.nombre && campos.password && campos.correo && campos.apellido && campos.ciudad && terminos.checked){
		formulario.reset();
